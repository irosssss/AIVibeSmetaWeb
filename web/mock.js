...
(function () {
  ...
  const db = {
    ...
    news: [
      ...
      { id: "n_2", title: "Ссылка на товар — сразу строка сметы: как это устроено", category: "Технологии", excerpt: "Клиппер читает карточку товара на сайте фабрики — название, артикул, цену и габариты — и кладёт готовую позицию в спецификацию.", body: "Полный текст про клиппер и извлечение данных со страниц товаров...", cover: "ar", author: "Ирина Соколова", date: "2026-05-21", status: "published", views: 7310 },
      ...
      { id: "n_4", title: "Смета за минуту: как не считать предметы вручную", category: "Гайды", excerpt: "Клиппер и библиотека собирают спецификацию с ценами и наценкой — разбор на реальном проекте.", body: "Полный текст гайда по смете и наценке...", cover: "market", author: "Максим Орлов", date: "2026-05-06", status: "published", views: 2640 },
